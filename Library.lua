...
Data = {
    NameOfYourScript = "Zeouron Library",
...
newtab("Tab 1", Data.Icons.Skull) -- You dont need a Icon, if you dont want one, remove "Data.Icons.Skull"
newtab("Tab 2")

button("button", "Tab 2", function()
	print("A button has been pressed!")
end, "This is a note") -- You can add a note after "end", if you dont want one, dont add it. You cannot add notes to labels tho.

label("label", "Tab 1")

switch("switch", "Tab 2", function()
	print(bool)
end)

textbox("textbox", "Tab 2", "text", function()
	print(string)
end)

slider("slider", "Tab 1", 5, 100, 50, function()
	print(number)
end)

keybind("keybind", "Tab 1", Enum.KeyCode.F, "F", function()
    print("A keybind has been activated!")
end)

keybind("keybind", "Tab 1", Enum.KeyCode.T, "T", function()
    print("A keybind has been activated!")
end)